...
<body>
  <div class=" row">
      ...
      <nav id="menu-bar" style="z-index:2000;" class=" bg-secondary menu-bar pt-1" styke="background:#005662;">
            <div class="scroll row middle-xs pt-2 center-xs">
                  <h3 style="padding-left:2em;   text-shadow: 3px 3px 3px #000000;" class="center-xs col-xs-10">MARKNET</h3>
                  ...
                  <?php if ($name_user == 'gammerstore@marknet.com') : ?>
                      <img style="width:10em;" src="../../resource/gaming.jpg" class="rounded-circle pt-3" title="Usuario">
                  <?php endif; ?>
                  ...
                  <div class="services">
                        ...
                        <a id="Drivers" class="py-2 item" style='text-decoration:none;
                          ...
                          <p style="text-shadow: 2px 2px 2px #000000;"  class="pl-3">Agencia</p>
                        </a>
         ...
         <div class="row  ">
             <div class="card col-xs-9 col-sm-4 col-md-3 col-lg-3 ">
                        <nav style="display:flex; justify-content:center; ">
                          ...
                          <h4 class="text-dark">Agregar Agencia</h4>
                          </div>
                        </nav>
                        ...
                        <div class="card-body" style="margin-left:3em;">
                                <form  method="post" id="drivers-form"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="enrollment_driver" placeholder="Nombre de la agencia "  style="font-size:11px; ">
                                    </div>

                                    <div class="form-group">
                                        <input class="form-control" type="text" name="nombre_usuario"
                                        id="enrollment_driver" placeholder="Crea un alias de la agencia "  style="font-size:11px; ">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="phone_driver" placeholder="NUmero adicional" style="font-size:11px; ">
                                    </div>
                                    <div class="form-group">
      ...
      <nav id="Reports_section" class="row center-xs container around-xs bg-light py-4 pr-4" style="width:100%; margin:auto; margin-top: 4em;"  >          
               <h3 style="color:#000000; margin-top:2em;">Reportes de clientes y utilidad</h3>
               <?php include('Graphics_Reports/line_graphics.php'); ?> 
               <h3 style="color:#000000; margin-top:2em;">Agencias con mayor envios </h3>

               <?php include('Graphics_Reports/bar_graphics.php'); ?>
               <h3 style="color:#000000; margin-top:2em;">Producos mas vendidos</h3>
      ...
      <div id="Products_section">
          ...
          <div id="btn-newproduct" style="display:flex;  margin-left:4em;justify-content:center; margin-top:6em;">
